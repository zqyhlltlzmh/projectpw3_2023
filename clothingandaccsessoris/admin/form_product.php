...
<head>
  ...
  <title>Clothing and Acsessoris | Dashboard</title>
...
<form method="POST" action="proses_product.php">
  ...
  <div class="form-group row">
    <label for="harga_beli" class="col-4 col-form-label">Name</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="purchase_price" a="purchase_price" 
        value="" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="sell_price" a="sell_price" 
        value="" type="text" class="form-control">
      </div>
    </div>
  </div>
  ...
  <div class="form-group row">
    <label for="min_stok" class="col-4 col-form-label">Tipe Produk</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="min_stok" class="col-4 col-form-label">Restock</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
