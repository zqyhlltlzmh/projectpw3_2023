    ...
    ?>
        <form method="post" action="proses_card.php">
            <table>
                ...
                <tr class="form-group row">
                    <td for="nama" class="col-4 col-form-label">CODE</td>
                    <td>
                        <input id="code" name="code" type="text" class="form-control" value="<?=$row['code']?>">
                    </td>
                </tr>
                <tr>
                    <td>Nama</td>
                ...
                <tr>
                    <td>Discount</td>
                    <td>
                    <input id="discount" name="discount" type="text" class="form-control" value="<?=$row['discount']?>">
                    </td>
                </tr>
                <tr>
                    <td>Member Fee</td>
                    <td>
                    <input id="member_fee" name="member_fee" type="text" class="form-control" value="<?=$row['member_fee']?>">
                    </td>
                </tr>
                <tr>
			        <td> 
