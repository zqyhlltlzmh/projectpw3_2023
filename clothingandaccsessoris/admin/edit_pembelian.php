        ...
        <form method="post" action="proses_pembelian.php">
            <table>
                ...
                <tr>
                    <td>total price</td>
                    <td>
                    <input id="total_" name="total_" type="text" class="form-control" value="<?=$row['total_']?>">
                    </td>
                </tr>
                <tr>
                <tr>
                    <td>CUTOMER ID</td>
                    <td>
                    <input id="Custimer" name="Custimer" type="text" class="form-control" value="<?=$row['Custimer']?>">
                    </td>
                </tr>
                <tr>
                    <td>ID product</td>
